/**
 * Inline-SVG icon path data shared between the React Icon component
 * (components/Icon.tsx) and any other consumer that needs raw SVG.
 *
 * Paths are Lucide-style — 24×24 viewBox, intended to render with
 * fill="none", stroke="currentColor", stroke-width=2, line-caps round.
 *
 * Mirror of api/src/icons.ts — keep both in sync.
 */
...
/**
 * Curated set of icons shown in the in-app + public-preview showcase grid.
 * 24 icons arranged 6 wide × 4 tall, or however auto-fit lays them out.
 */
export const SHOWCASE_ICONS: IconName[] = [
  'arrowRight',
  'arrowLeft',
  'plus',
  'check',
